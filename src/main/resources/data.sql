...
insert into book(id,add_date, isbn, category, cover, number_of_pages, title, url_pdf, book_info_id, pub_house_id) values(1,sysdate,'9992158107',	'Art',	null, 455	, 'title', '1.pdf',	1,	2);
